...
namespace DotNetAuthorizeFunction
{
    ...
    {
        internal static string audience = ""; // Get this value from the expose an api, audience uri section example https://appname.tenantname.onmicrosoft.com
        internal static string clientID = ""; // this is the client id, a GUID
        internal static string tenant = "tenantname.onmicrosoft.com"; // this is your tenant name
        internal static string tenantid = ""; // this is your tenant id (GUID)
